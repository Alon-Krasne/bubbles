...
The stage preserves the background aspect ratio at desktop and landscape-tablet sizes. All seven zone IDs and twelve placement keys stay unchanged; only their visual coordinates change. No save-format changes or reset. Final visual acceptance remains with the user and daughter after trying the preview.
