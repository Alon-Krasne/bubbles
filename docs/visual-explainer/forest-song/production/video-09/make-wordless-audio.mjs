...
const rate=48000, seconds=18, n=rate*seconds;
...
for(const x of [[.8,523.25,1.8,.065,-.3],[1.45,659.25,1.8,.065,0],[2.1,783.99,2,.065,.3],[3.1,1046.5,2,.045,0],[6.4,523.25,2.6,.06,-.3],[7.1,659.25,2.6,.055,0],[7.8,783.99,2.6,.055,.3],[8.5,1046.5,3,.045,0],[12.7,659.25,1.2,.045,-.3],[13.6,783.99,1.2,.045,.3],[15.1,783.99,2.1,.045,0],[16.1,1046.5,1.7,.04,0]]) note(...x);
