...
The first playable story segment is the opening video, Memory, Shop, Magic House, Memory, Shop, then video 2. The existing 36-stage route continues with the nine shared video masters at milestones 0/5/10/15/20/25/30/35/36. Captions initially use the child's learning language; the player supports Hebrew, English and no captions. Children can skip a pending video or replay unlocked stories from the map. The production videos remain the reviewed drafts with their recorded continuity limitations.
