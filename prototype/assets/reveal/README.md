...
- `strawberry-island.webp`: tiny floating island with a strawberry cottage, curved stepping-stone path, rounded peach and mint trees, a sparkling waterfall spilling into fluffy clouds and a smiling sun.
- `pearl-village.webp`: underwater village with rounded seashell cottages, a friendly turtle, colorful fish, curving coral, a glowing pearl in an open shell and bubbles catching sunbeams.
- `moon-garden.webp`: crescent-moon cottage on clouds, rabbit tending star-shaped flowers, friendly birds, lanterns, curved stepping stones, a little telescope and sparkling stars; warm magical evening.

- `woodland-bakery.webp`: cozy bakery in a hollow tree, bear baker handing a rabbit a warm bun, bread baskets, flower boxes, curved path and birds; soft morning light.
- `rainbow-railway.webp`: colorful little train crossing a curved bridge between cloud islands, cheerful animal passengers, rounded station, floating gardens and rainbow.
